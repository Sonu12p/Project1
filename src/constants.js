...
export const filterActivityOptions = [
  { color: '#E2B16D', bgColor: '#F9EBD3', name: "APPT_REQUEST", value: "APPT_REQUEST", label: "Appt Request" },
  { color: '#646CE1', bgColor: '#DFDFF7', name: "FORM", value: "FORM", label: "Form" },
  { color: '#6CB158', bgColor: '#DEF3DA', name: "APPOINTMENT", value: "APPOINTMENT", label: "Appointment" },
  { color: '#6A98C2', bgColor: '#D7E8F5', name: "PAYMENT", value: "PAYMENT", label: "Payment" },
  { color: '#bdc3c7', bgColor: '#061417', name: "REVIEW", value: "REVIEW", label: "Review" },
  { color: '#CD6661', bgColor: '#F2DDDC', name: "FEEDBACK", value: "FEEDBACK", label: "Feedback" }
];
